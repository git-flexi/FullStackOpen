...
describe('favorite blog', () => {
  test('get me the best blog out of many', () => {
    const result = listHelper.favoriteBlog(multiBlogs);
    expect(result).toEqual(multiBlogs[2]);
  });

  test('gimme nothing cause i give you nothing', () => {
