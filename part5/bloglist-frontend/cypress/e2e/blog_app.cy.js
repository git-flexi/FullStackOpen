describe('Blog app', function () {
  ...
  describe('When logged in', function () {
    ...
    it('A blog can be created', function () {
      ...
      cy.get('.message').should('contain', 'A new Blog New Blog by Flexifailix added');
      cy.get('.blog').should('contain', 'New Blog by Flexifailix');
    });

    describe('and multiple blogs exists', function () {
      beforeEach(function () {
        cy.createBlog({ title: 'Blog1', author: 'Author1', url: 'www.randomUrl1.com' });
        cy.createBlog({ title: 'Blog2', author: 'Author2', url: 'www.randomUrl2.com' });
        cy.createBlog({ title: 'Blog3', author: 'Author3', url: 'www.randomUrl3.com' });
      });
      ...
      it('A blog can be deleted by creator', function () {
        cy.createBlog({ title: 'Deletionblog', author: 'Author4', url: 'www.randomUrl4.com' });
